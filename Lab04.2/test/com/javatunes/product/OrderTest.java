...
public class OrderTest {
  ...
  public void testProcessCart() {
    Order order1 = new Order("order-1");       //passing ShoppingCart<Product>
    order1.processCart(productCart);
    System.out.println();

    Order order2 = new Order("order-2");        //passing ShoppingCart<Music Item>
    order2.processCart(musicCart);
    System.out.println();

    Order order3 = new Order("order-3");        //passing ShoppingCart<MediaPlayer>
