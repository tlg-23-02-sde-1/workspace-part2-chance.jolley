...
public class EmployeeFactory {
  ...
  /**
   * given the input map, create and return the correct
   * object (with its properties set).
  ...
  throws IllegalArgumentException {
    ...
    if ("SE".equals(type)) {
      ...
      Double hour = Double.valueOf(inputMap.get("hours"));
      emp = new HourlyEmployee(name, hireDate, rate, hour);
    }
    return emp;
  }
}